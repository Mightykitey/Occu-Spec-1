...
//Navigation item: Link to the Carbon footprint calculator
//echo "<li><a href='calc.php'>Carbon Footprint Calculator</a></li>";

// Navigation item: Link to the registration page
echo "<li><a href='reg.php'>Registration</a></li>";

// Navigation item: link for booking functionality
echo "<li><a href='booking.php'>WIP</a></li>";

// Navigation item: link for booked appointments
echo "<li><a href='apt.php'>WIP</a></li>";

// Navigation item: link for login
